...
/// <summary>
/// xUnit v3 compatible replacement for <c>Microsoft.DotNet.XUnitExtensions.ConditionalTheoryAttribute</c>.
/// Skips the test when the specified static member on the given type evaluates to <see langword="false"/>.
/// </summary>
[AttributeUsage(AttributeTargets.Method, AllowMultiple = false)]
public sealed class ConditionalTheoryAttribute : TheoryAttribute
{
    public ConditionalTheoryAttribute(Type conditionType, string conditionMember)
    {
